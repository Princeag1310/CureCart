    ...
    <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col h-full bg-white border-gray-100">
      <div className="relative aspect-square w-full bg-gray-50 flex items-center justify-center p-4">
        ...
        {medicine.requiresPrescription && (
          <div className="absolute top-2 left-2 bg-red-100 text-red-700 text-xs font-bold px-2 py-1 rounded-full">
            Rx Required
          </div>
        )}
      </div>
      ...
      <CardContent className="flex-1 p-4">
        <h3 className="font-semibold text-lg text-gray-900 line-clamp-1">{medicine.name}</h3>
